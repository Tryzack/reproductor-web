...
(function (v) {
	"object" === typeof exports && "undefined" !== typeof module
		...
		? define([], v)
		: (("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).jsmediatags =
				v());
})(function () {
							...
							[
								{
									...
									value: function (a) {
										return (
											("undefined" !== typeof Blob && a instanceof Blob) || ("undefined" !== typeof File && a instanceof File)
										);
									},
								},
							]
				...
				function (h, p, n) {
					...
					h = (function () {
						function h() {
							...
							"_fileData" in this
								? Object.defineProperty(this, "_fileData", { value: void 0, enumerable: !0, configurable: !0, writable: !0 })
							...
							},
							{
								...
								value: function (f, c) {
									...
									for (
										...
										!((g = this._fileData[e].offset), (b = g + this._fileData[e].data.length), c >= g - 1 && (r = e), c <= b + 1);
										e++
									);
									-1 === r && (r = k);
					...
					function m(b) {
						m =
							"function" === typeof Symbol && "symbol" === typeof Symbol.iterator
								...
								: function (b) {
										return b && "function" === typeof Symbol && b.constructor === Symbol && b !== Symbol.prototype
											? "symbol"
											: typeof b;
								  };
						return m(b);
								...
								},
								{
									...
									value: function (a, e) {
										...
										a = {
											type: "ID3",
											version: r,
											tags: { title: b, artist: c, album: k, year: f, comment: h, genre: 255 > a ? g[a] : "" },
										};
										e && (a.tags.track = e);
										return a;
									},
							...
							for (var e = 0; k < g; e++) {
								...
								if (0 == l) break;
									...
									216 > d || 224 <= d
										...
										: ((d = (c[k + h] << 8) + c[k + a]), (k += 2), (b[e] = String.fromCharCode(l, d)));
							}
